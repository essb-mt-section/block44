...
Literature: Field par. 7.5 (part and partial correlations) + Chapter 8
...
| --------------- | ------------------------- |
| Chapter 7       | Chapter 8  (but not 8.6)  |
...
*see  Chapter 7.5 & Chapter 8 (Field, 2013)*
...
Now, draw two Venn diagrams (Like in Field, 2013, p. 282, you may use overlapping squares or circles to show the principle of shared variation):
...
The parttial correlation between $Y$ and $X3$ while controlling for $X1$ (see table 3) equals $.61^2 = .37$. Thus, after we rule out the variance that $X3$ shares with $X1$, $X3$ explains 37% of the variance in $Y$.
