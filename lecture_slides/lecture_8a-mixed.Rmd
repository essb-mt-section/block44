...
`r image("incl/tidy-data.png", width="70%")`
...
`r image("incl/mixed_anova_levene.png", width="55%")`
...
`r image("incl/mixed_anova_sphericity.png", width="80%")`
...
plt +  theme(legend.position = "none") +
  geom_line(data=filter(plotdata, looks != "ugly"),
            mapping = aes(group = subject_id, color = subject_id), lwd=2)
```
]
...
`r image("incl/mixed_anova_correct_mapping.png", width="80%")`
...
`r image("incl/mixed_anova_incorrect_mapping.png", width="80%")`
...
`r image("incl/mixed_anova_results1.png", width="80%")`

---
# Between-Subjects Effects
`r image("incl/mixed_anova_results2.png", width="70%")`
...
plt = ggplot(plotdata, aes(looks, preference)) +
  ...
  geom_line(mapping = aes(group = gender, color = gender), lwd=1)
```
...
plt = ggplot(plotdata, aes(charisma, preference)) +
  ...
  geom_line(mapping = aes(group = looks, color = looks), lwd=1)
```
